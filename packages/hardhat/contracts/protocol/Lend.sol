...
*/
    ...
    ) internal validPool(params.timestamp) {
...
*/
    function getNextActivePool(uint40 timestamp) view validTimestamp(timestamp) internal returns (uint40 nextActivePoolTimestamp) {
