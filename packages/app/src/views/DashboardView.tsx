            ...
            <div className="card w-full text-left">
              <div className="card-body ">
                <div className="flex-col gap-2">
                  ...
                  {/*deposit modal*/}
                  <Modal
                    isOpen={extendDepositModalOpen}
                    onClose={() => setExtendDepositModalOpen(false)}
                  >
                    <ExtendDepositView
                      deposit={selectedDeposit}
                  ...
                  {/*borrow modal*/}
                  <Modal
                    isOpen={extendBorrowModalOpen}
                    onClose={() => setExtendBorrowModalOpen(false)}
                  >
                    <ExtendBorrowView
                                      ...
                                      <td className="px-6 py-4 text-sm font-bold">
                                        {wallet ? (
                                          <p>
                                            ...
                                            {storeBorrow.currentBalanceOverride
                                              ? storeBorrow.currentBalanceOverride
                                              : formatLargeUsdc(
                                                  borrow.debt,
                                                )}{" "}
