      ...
      <div className="relative group mt-4 w-full min-w-[500px]">
        <div className="flex flex-col">
          ...
          <p className="text-shrub-grey-700 text-lg text-left font-light pt-8 max-w-[550px]">
            Making a partial payment of {formatLargeUsdc(repayAmount)} USDC to
            your borrow will reduce the interest to 0 USDC and the principal to{" "}
            {formatLargeUsdc(newPrincipal)} USDC. The LTV of the loan will
            change from {formatPercentage(originalBorrowLTV)}% to{" "}
            {formatPercentage(newLtv)}%. You will not receive any collateral
            back, nor will this affect the APY of this borrow which is{" "}
            {formatPercentage(borrow.apy)}%.
          </p>
